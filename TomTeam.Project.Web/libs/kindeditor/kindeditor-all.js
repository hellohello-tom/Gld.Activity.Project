...
(function (window, undefined) {
    ...
    _extend(KCmd, {
        ...
        insertimage: function (url, title, width, height, border, align) {
            ...
            var html = '<img  class="lazyImg" data-original="' + _escape(url) + '"  src="' + _escape(url) + '" data-ke-src="' + _escape(url) + '" ';
            if (width) {
...
KindEditor.plugin('emoticons', function (K) {
    ...
    self.clickToolbar(name, function () {
        ...
        function bindCellEvent(cell, j, num) {
            ...
            cell.click(function (e) {
                self.insertHtml('<img class="lazyImg" data-original="' + path + num + '.gif" src="' + path + num + '.gif" border="0" alt="" />').hideMenu().focus();
                e.stop();
            });
        }
