...
using TomTeam.Project.Net.MimeTypes;
using OfficeOpenXml;

namespace TomTeam.Project.DataExporting.Excel.EpPlus
{
    public abstract class EpPlusExcelExporterBase : TomAbpServiceBase, ITransientDependency
    {
