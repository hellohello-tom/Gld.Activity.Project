		...
		function E(K, J) {
			...
			function C() {
				...
				for (var C = 0; C < D.length; C++)
					if (D[C].name == J.skin) $.push("<link rel=\"stylesheet\" type=\"text/css\" href=\"" + A + "skin/" + D[C].name + "/datepicker.css\" charset=\"" + D[C].charset + "\"/>","<link rel=\"stylesheet\" type=\"text/css\" href=\"" + A + "skin/" + D[C].name + "/yqyIco/style.css\" charset=\"" + D[C].charset + "\"/>");
